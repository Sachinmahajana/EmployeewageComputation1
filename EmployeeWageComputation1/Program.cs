namespace EmployeeWageComputation1
{
    internal class Program
    {
        ...
        static void Main(string[] args)
        {
            ...
            ComputeEmpWage("Deloitee",25,50,30);
            ComputeEmpWage("Infosys", 30, 40, 35);
            ComputeEmpWage("Wipro", 20, 30, 80);
            Console.ReadLine();
        }
        public static void ComputeEmpWage(string Company,int maxWorkingDays,int maxWorkingHrs,int empRatePerHrs)
        {  
